...
public class OperationsTest {
    ...
    public void testGetMax() {
        ...
        double actualMax = operations.getMax();
    ...
    public void testGetMin() {
        ...
        double actualMin = operations.getMin();
    ...
    public void testMaxSum() {
        double[] testArray = {1, 2.5, 4.2, 4.3, 9, 1.1, 13, 100.3, 7.4};
        double expectedSum = 157.8; // (2.5 + 4.2 + 4.3 + 9 + 1.1 + 13 + 7.4)
        double actualSum = operations.maxSum();
    ...
    public void testMinSum() {
        double[] testArray = {1, 2.5, 4.2, 4.3, 9, 1.1, 13, 100.3, 7.4};
        double expectedSum = 142.1; // (2.5 + 4.2 + 4.3 + 9 + 1.1 + 13 + 100.3)
        double actualSum = operations.minSum();
        assertEquals(expectedSum, actualSum, 0.01);
    }
    ...
    public void testInvalidMaxSum() {
        double[] testArray = {};
        assertThrows(RuntimeException.class, () -> operations.maxSum());
    }

    @Test
    public void testInvalidMinSum() {
        double[] testArray = {};
        assertThrows(RuntimeException.class, () -> operations.minSum());
    }
}
